...
class Mention implements \JsonSerializable
{
    ...
    {        
        $this->_commentCount       = $data[self::DATA_COMMENT_COUNT_KEY];
        ...
        $this->_linkedinCount      = $data[self::DATA_LINKEDIN_COUNT_KEY];
        ...
        $this->_numberOfSimilars   = $data[self::DATA_NUMBER_OF_SIMILARS_KEY];
        $this->_pinterestCount     = $data[self::DATA_PINTEREST_COUNT_KEY];
        $this->_photo              = $data[self::DATA_PHOTO_KEY];
        $this->_prValue            = $data[self::DATA_PR_VALUE_KEY];
        $this->_reach              = $data[self::DATA_REACH_KEY];
        $this->_redditCommentCount = $data[self::DATA_REDDIT_COMMENT_COUNT_KEY];
        $this->_redditDownCount    = $data[self::DATA_REDDIT_DOWNS_COUNT_KEY];
        $this->_redditUpsCount     = $data[self::DATA_REDDIT_UPS_COUNT_KEY];
        $this->_shareCount         = $data[self::DATA_SHARE_COUNT_KEY];
