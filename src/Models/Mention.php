...
class Mention implements \JsonSerializable
{
    ...
    {        
        ...
        $this->_influenceScore     = $data[self::DATA_INFLUENCE_SCORE_KEY] ?? 0;
        ...
        $this->_likeCount          = $data[self::DATA_LIKE_COUNT_KEY] ?? 0;
        ...
        $this->_prValue            = $data[self::DATA_PR_VALUE_KEY] ?? 0;
        $this->_reach              = $data[self::DATA_REACH_KEY] ?? 0;
